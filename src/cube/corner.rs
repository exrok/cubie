...
impl CornerMap {
    ...
    pub fn inverse_multiply(self, b: CornerMap) -> CornerMap {
        CornerMap {
            set: map_inv_mul(self.set, b.set),
        }
    }
    ...
    pub fn print(self) {
        ...
        for i in (0..8).rev() {
            eprint!(
                " {:1}:{:1}  ",
                ((self.set >> ((7 - i) * 8)) >> 2) & 0b11,
                (self.set >> ((7 - i) * 8)) & 0b111
            );
        }
        eprintln!("");
    }
...
impl std::convert::From<FaceMove> for CornerMap {
    ...
    fn from(turn: FaceMove) -> Self {
        let turns = &[
            CornerMap {
                set: 0x0702050603000104,
            }, //Ucw
            CornerMap {
                set: 0x0700050203040106,
            }, //U2
            CornerMap {
                set: 0x0704050003060102,
            }, //Uccw
            CornerMap {
                set: 0x0506010407020300,
            }, //Dcw
            CornerMap {
                set: 0x0106030405020700,
            }, //D2
            CornerMap {
                set: 0x0306070401020500,
            }, //Dccw
            CornerMap {
                set: 0x07060c1003021509,
            }, //Fcw
            CornerMap {
                set: 0x0706000103020405,
            }, //F2
            CornerMap {
                set: 0x070609150302100c,
            }, //Fccw
            CornerMap {
                set: 0x130f05040a160100,
            }, //Bcw
            CornerMap {
                set: 0x0203050406070100,
            }, //B2
            CornerMap {
                set: 0x160a05040f130100,
            }, //Bccw
            CornerMap {
                set: 0x07060504110b0812,
            }, //Rcw
            CornerMap {
                set: 0x0706050400010203,
            }, //R2
            CornerMap {
                set: 0x0706050412080b11,
            }, //Rccw
            CornerMap {
                set: 0x0e14170d03020100,
            }, //Lcw
            CornerMap {
                set: 0x0405060703020100,
            }, //L2
            CornerMap {
                set: 0x0d17140e03020100,
            }, //Lccw
        ];
        turns[turn as usize]
    }
